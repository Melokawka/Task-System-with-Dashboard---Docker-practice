...
INSERT INTO tasks (id, project_id, title, description, status, due_date)
VALUES (1, 1, 'Design database schema', 'Create tables for tasks and assignments', 'COMPLETED', '2025-09-30');

INSERT INTO tasks (id, project_id, title, description, status, due_date)
VALUES (2, 1, 'Implement REST API', 'Build CRUD endpoints for Task entity', 'IN_PROGRESS', '2025-10-05');
